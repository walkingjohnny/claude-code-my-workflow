...
# 输出：data/v3_supply_majors_raw.parquet（解析后的聚合文本）
#       data/v3_supply_majors.parquet（LLM 抽取后的最终供给侧画像）
...
OUT_RAW = pathlib.Path("data/v3_supply_majors_raw.parquet")
OUT_FINAL = pathlib.Path("data/v3_supply_majors.parquet")
...
# ============================================================
# 3. 阶段 A：解析 + 聚合 → v3_supply_majors_raw.parquet
# ============================================================
def run_phase_a():
    print("=" * 60)
